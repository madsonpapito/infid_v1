      ...
      <div className="space-y-6 animate-fade-in w-full max-w-lg mx-auto pb-20">
        ...
        <div ref={checkoutRef} className="bg-[#0B1120] border border-cyan-500/50 rounded-2xl shadow-[0_0_40px_rgba(6,182,212,0.15)] p-6 text-center relative overflow-hidden">
          ...
          <a
            href={checkoutHref}
            onClick={fireIC}
            className="block w-full bg-emerald-500 hover:bg-emerald-400 text-[#0B1120] font-black py-5 rounded-2xl shadow-[0_20px_40px_rgba(16,185,129,0.3)] transition-all transform hover:scale-[1.02] active:scale-[0.98] uppercase tracking-widest text-base relative z-10 easyt-next-page"
          >
          ...
          <div className="flex flex-col items-center gap-4 mt-6">
            <div className="flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-full">
              <div className="bg-emerald-500 rounded-full p-1">
                <CheckCircle2 className="w-3 h-3 text-[#0B1120]" />
              </div>
              <span className="text-[10px] font-black text-emerald-400 uppercase tracking-widest pt-0.5">7 Días de Garantía de Reembolso</span>
            </div>
            
            <div className="flex justify-center items-center gap-6 text-[10px] text-slate-500 font-mono opacity-60">
              <span className="flex items-center gap-1.5"><ShieldCheck className="w-3.5 h-3.5" /> 256-bit SSL</span>
              <span className="flex items-center gap-1.5"><Lock className="w-3.5 h-3.5" /> Encriptado</span>
            </div>
          </div>
        </div>
