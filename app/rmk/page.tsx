...
function RemarketingResultsContent() {
  ...
  // Link atualizado para checkout direto (dinâmico com parâmetros)
  ...
  return (
    <div className="min-h-screen bg-[#0B1120] text-slate-100 font-sans selection:bg-rose-500/30 overflow-x-hidden">
      ...
      <main className="pt-20 pb-40 px-5 max-w-md mx-auto space-y-12">
        ...
        <section className="text-center space-y-5 animate-in fade-in slide-in-from-bottom-6 duration-1000">
          ...
          <p className="text-slate-400 text-sm font-medium leading-relaxed px-4">
            El escaneo profundo del objetivo se ha completado. Las interacciones privadas y las ubicações ocultas están listas para ser vistas. 
           ...
           <div className="flex gap-3 overflow-x-auto pb-4 pt-1 snap-x scrollbar-hide">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="flex-shrink-0 w-36 h-48 bg-slate-800 rounded-2xl relative overflow-hidden group snap-center border border-slate-700">
                   ...
                   <div className="absolute bottom-2 left-1/2 -translate-x-1/2 bg-black/60 px-2 py-1 rounded text-[8px] font-black text-rose-400 uppercase tracking-widest whitespace-nowrap">CONTENIDO BLOQUEADO</div>
                </div>
              ))}
           </div>
        </section>
            ...
            >
              <div className="w-[280px] shrink-0 snap-center flex flex-col gap-4">
                ...
                <div className="bg-slate-900/80 p-5 rounded-2xl border border-slate-800 shadow-inner">
                  ...
                  <p className="text-[11px] text-slate-400 font-medium italic leading-relaxed">&quot;Sinceramente no pensé que funcionaría, mas el informe mostró chats eliminados que lo explicaban todo.&quot;</p>
                </div>
              </div>
              ...
              <div className="w-[280px] shrink-0 snap-center flex flex-col gap-4">
                ...
                <div className="bg-slate-900/80 p-5 rounded-2xl border border-slate-800 shadow-inner">
                  ...
                  <p className="text-[11px] text-slate-400 font-medium italic leading-relaxed">&quot;En cuestión de minutos me mostrou mensagens ocultos e incluso notas de voz.&quot;</p>
                </div>
              </div>
        ...
        <section className="text-center space-y-10 pb-24 relative">
          ...
          <div className="inline-flex flex-col items-center gap-3 relative z-10">
            <span className="text-[10px] text-slate-600 font-black uppercase tracking-[0.3em]">Acceso Confidencial de Remarketing</span>
            ...
            <div className="bg-emerald-500/10 border border-emerald-500/40 px-4 py-1.5 rounded-full flex items-center gap-2">
               ...
               <span className="text-[11px] font-black text-emerald-400 uppercase tracking-widest pt-0.5">DESCUENTO DE $10 ACTIVO</span>
            </div>
          </div>
          ...
          <div className="space-y-8 relative z-10">
            ...
            >
              <span className="relative z-10 text-xl uppercase tracking-[0.2em] flex items-center justify-center gap-3">
                VER LA EVIDENCIA AHORA <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" />
              </span>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-center gap-4 pt-6 mt-6 border-t border-slate-900">
                 <div className="text-right">
                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">LA EVIDENCIA EXPIRA EN</p>
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[92%] max-w-sm z-50 animate-in slide-in-from-bottom-12 transition-all">
         ...
         >
           <span className="uppercase tracking-widest text-xs pt-0.5">Revelar Perfiles Secretos Ahora</span>
