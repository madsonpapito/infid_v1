        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
            ...
            <div className="bg-amber-100 text-amber-800 py-3 px-4 text-center border-b border-amber-200">
                <p className="text-sm md:text-base font-bold uppercase tracking-wide">
                    ⚠️ ÚLTIMO PASO: ESTA ES TU ÚLTIMA OPCIÓN DE MEJORA.
                </p>
            </div>
                ...
                <div className="max-w-3xl mx-auto text-center space-y-8">
                    <div>
                        ...
                        <p className="text-slate-600 max-w-lg mx-auto leading-relaxed">
                            Normalmente reservo este protocolo para mis clientes de mentoría privada. Pero quiero que estés a salvo.
                        </p>
                    </div>
                    ...
                    <div className="pt-2">
                        ...
                        >
                            No gracias. Confío en que puedo controlar mis emociones durante la confrontación sin ayuda. Correré el riesgo de abrumarme.
                        </Link>
                    </div>
                </div>
            </section>
