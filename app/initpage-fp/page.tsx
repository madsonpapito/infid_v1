                ...
                <div className="max-w-3xl mx-auto space-y-8">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="flex items-center gap-2 text-sm text-blue-200 opacity-90">
                            <Lock className="w-4 h-4" /> Pago Seguro vía Fortpay
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                            ...
                            <p className="text-slate-600">Sí, 100% seguro. El pago es procesado por Fortpay, una de las plataformas más seguras. Tus datos están protegidos.</p>
                        </div>
                        {/* FAQ Item 2 */}
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
