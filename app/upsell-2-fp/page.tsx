                        ...
                        <div className="animate-in slide-in-from-bottom-8 space-y-4 pt-2">
                            ...
                            <div id="unlock-widget" className="text-center bg-[#0B1120] border border-rose-500/50 shadow-[0_0_30px_rgba(244,63,94,0.15)] rounded-2xl p-6 relative overflow-hidden mt-2">
                                ...
                                <div className="w-full flex flex-col items-center gap-3 pt-2">
                                    <button type="button" data-fortpay="nqozvq7tqg" className="fortpay_btn w-full py-4 bg-gradient-to-r from-[#3d94f6] to-[#1e62d0] text-white font-bold rounded-xl shadow-lg transition-all text-center">VER INFORME COMPLETO</button>
                                    <a href="/downsell-2-fp" className="text-[#004faa] text-sm hover:underline">No quiero acceso</a>
                                </div>
                            </div>
