        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
                    ...
                    <div className="bg-slate-800 rounded-2xl aspect-video flex items-center justify-center relative overflow-hidden shadow-xl">
                        ...
                        <div className="text-center z-10 p-6">
                            ...
                            <p className="text-white/80 text-sm md:text-base max-w-md">
                                &ldquo;La mayoría de la gente piensa que borrar un mensaje borra la evidencia. No es así. Tu teléfono registra todo...&rdquo;
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20 px-4 md:px-8 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white">
                <div className="max-w-3xl mx-auto text-center space-y-8">
                    <div>
                        <p className="text-blue-200 text-lg mb-2">La oferta:</p>
                        <p className="text-blue-100 leading-relaxed">
                            Normalmente, vendemos este módulo avanzado por separado por <span className="line-through opacity-70">$97</span> porque es muy potente.
                        </p>
                        <p className="text-white leading-relaxed mt-2">
                            Pero como eres un nuevo miembro, y quiero que tengas la <strong>verdad COMPLETA</strong>, puedes agregar esto a tu pedido ahora mismo por un único pago de:
                        </p>
                    </div>
                    ...
                    <div className="pt-4">
                        ...
                        >
                            No gracias, no quiero la prueba digital. Confiaré solo en mi intuición y en las señales del lenguaje corporal.
                        </Link>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 px-4 md:px-8 bg-slate-100">
                <div className="max-w-3xl mx-auto text-center space-y-6">
                    ...
                    >
                        ✅ ¡SÍ! Agregar el Kit de Auditoría Digital - Solo $47
                    </Link>
